...
clear all
use *netto psample letztbef using ~/data/soep/soep30/stata/ppfad.dta 
...
local row=1
qui foreach wv in a b c d e f g h i j k l m n o p q r s t u v w x y z ba bb bc bd {
   forvalues i=1/`cols' {
...
local colnm "A B C D E F G H I J K M"
...
#d;
graph bar (first) A B C D E F G H I J K M, over(year, label(angle(ninety))) stack 
